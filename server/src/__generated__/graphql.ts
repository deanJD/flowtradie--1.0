...
export type CreateProjectInput = {
  ...
  siteAddress: InputMaybe<ProjectSiteAddressInput>;
...
export type ProjectSiteAddressInput = {
  city: Scalars['String']['input'];
  country: InputMaybe<Scalars['String']['input']>;
  countryCode: InputMaybe<Scalars['String']['input']>;
  line1: Scalars['String']['input'];
...
export type ResolversTypes = ResolversObject<{
  ...
  ProjectSiteAddressInput: ProjectSiteAddressInput;
...
export type BusinessResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Business'] = ResolversParentTypes['Business']> = ResolversObject<{
  ...
  businessNumber: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ProjectResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Project'] = ResolversParentTypes['Project']> = ResolversObject<{
  ...
  siteAddress: Resolver<Maybe<ResolversTypes['Address']>, ParentType, ContextType>;
...
export type QueryResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  invoices: Resolver<Array<ResolversTypes['Invoice']>, ParentType, ContextType, QueryInvoicesArgs>;
