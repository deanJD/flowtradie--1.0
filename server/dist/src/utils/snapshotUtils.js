 ...
 */
export async function getBusinessSnapshot(businessId) {
    ...
    const snapshot = {
        ...
        address: settings?.addressSnapshot ??
            (business.address
                ? {
 ...
 */
export async function getClientSnapshot(clientId, addressId) {
    ...
    const selectedAddress = (addressId && client.addresses.find((a) => a.id === addressId)) ||
